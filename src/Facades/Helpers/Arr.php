 ...
 * @method static array map(ArrayAccess|array $array, callable $callback)
 * @method static array merge(...$arrays)
 * @method static array only(ArrayAccess|array $array, array|string $keys)
 ...
 * @method static mixed get(ArrayAccess|array $array, $key, $default = null)
 * @method static mixed getKey(ArrayAccess|array $array, $key, $default = null)
 * @method static void store(ArrayAccess|array $array, string $path, bool $is_json = false, bool $sort_keys = false)
 * @method static void storeAsArray(string $path, ArrayAccess|array $array, bool $sort_keys = false)
 * @method static void storeAsJson(string $path, ArrayAccess|array $array, bool $sort_keys = false)
 */
