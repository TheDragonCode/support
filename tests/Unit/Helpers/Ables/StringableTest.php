...
namespace Tests\Unit\Helpers\Ables;
...
class StringableTest extends TestCase
{
    ...
    {
        $this->assertSame('', (string) $this->str(''));
        $this->assertInstanceOf(Stringable::class, $this->str(''));

        $this->assertSame('', (string) $this->str(null));
        $this->assertInstanceOf(Stringable::class, $this->str(null));

        $this->assertSame('foo', (string) $this->str('foo'));
        $this->assertInstanceOf(Stringable::class, $this->str('foo'));
    }
